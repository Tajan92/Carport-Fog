...
public class QuoteService {
    ...
    public QuoteService(QuoteMapper quoteMapper, CarportService carportService, CustomerMapper customerMapper, SalesRepMapper salesRepMapper, CarportMapper carportMapper, UserService userService, ProductMapper productMapper, PartsListMapper partsListMapper) {
