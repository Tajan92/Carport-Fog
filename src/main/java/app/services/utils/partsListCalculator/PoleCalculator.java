...
public class PoleCalculator {
    ...
    public void addPoleProducts(List<ProductsPartsListEntry> productsPartsListEntries, Shed shed, Carport carport, List<Product> products) throws CalculatorException {
